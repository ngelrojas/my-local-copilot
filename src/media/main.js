(function () {
  ...
  document.addEventListener("DOMContentLoaded", (event) => {
    ...
    function sendInfoChat() {
      ...
      btnReSend.className = "resend text-gray-500 opacity-50 hover:opacity-100 hover:text-slate-400 m-0.5";
