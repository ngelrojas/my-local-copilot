  ...
  document.addEventListener("DOMContentLoaded", (event) => {
    ...
    if (sendButton) {
      sendButton.addEventListener("click", () => {
        ...
        userRequestIn.className = "ollama-section-request py-0.5 px-0.5";
    ...
    window.addEventListener("message", (event) => {
      ...
      switch (message.command) {
        case "response":
          ...
          botResponse.className = "ollama-section-response py-0.5 px-0.5";
          document.getElementById("wrap-ollama-section").appendChild(botResponse);
